...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+ table[y index=1] {data/mse_LASSO.dat};
            \addlegendentry{LASSO};
        \end{axis}
    \end{tikzpicture}
    \caption{\(R^2\) score on test data.}
\end{figure}
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+ table[y index=2] {data/mse_LASSO.dat};
            \addlegendentry{MSE (LASSO)};
            \addplot+ table[y index=3] {data/mse_LASSO.dat};
            \addlegendentry{Bias (LASSO)};
            \addplot+ table[y index=4] {data/mse_LASSO.dat};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{data/J_ols1.png}
...
for line in io.lines("data/Ridge_lambdas.dat") do
    ...
    s = ""
        ...
        .. [[\begin{subfigure}[b]{0.45\textwidth} \centering]]
            .. [[\includegraphics[height=0.20\textheight]{data/J_Ridge]] .. tostring(i) .. [[.png}]]
            .. [[\caption{Ridge regression}]]
        .. [[\end{subfigure}]]
        .. [[\begin{subfigure}[b]{0.45\textwidth} \centering]]
            .. [[\includegraphics[height=0.20\textheight]{data/J_LASSO]] .. tostring(i) .. [[.png}]]
            .. [[\caption{LASSO regression}]]
        .. [[\end{subfigure}]]
        .. [[\caption{Coupling matrix for \(\lambda = \num{]] .. line ..[[}\)}]]
    .. [[\end{figure}]]
    tex.sprint(s)
    ::next::
    i = i + 1
