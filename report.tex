...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+ table[y index=1] {data/mse_Ridge.dat};
...
\begin{figure}[H]
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            \addplot+ table[y index=2] {data/mse_Ridge.dat};
            \addlegendentry{MSE (Ridge)};
            \addplot+ table[y index=3] {data/mse_Ridge.dat};
            \addlegendentry{Bias (Ridge)};
            \addplot+ table[y index=4] {data/mse_Ridge.dat};
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{data/J_ols_1.png}
...
for line in io.lines("data/Ridge_lambdas.dat") do
    ...
    s = ""
        ...
        .. [[\begin{subfigure}[t]{0.3\textwidth} \centering]]
            .. [[\includegraphics[height=0.20\textheight]{data/J_Ridge_]] .. tostring(i) .. [[.png}]]
            .. [[\caption{Ridge regression, \(\num{1000}\) training states.}]]
        .. [[\end{subfigure}\hspace{0.04\textwidth}]]
        .. [[\begin{subfigure}[t]{0.3\textwidth} \centering]]
            .. [[\includegraphics[height=0.20\textheight]{data/J_LASSO_400_]] .. tostring(i) .. [[.png}]]
            .. [[\caption{LASSO regression, \(\num{400}\) training states.}]]
        .. [[\end{subfigure}\hspace{0.04\textwidth}]]
        .. [[\begin{subfigure}[t]{0.3\textwidth} \centering]]
            .. [[\includegraphics[height=0.20\textheight]{data/J_LASSO_1000_]] .. tostring(i) .. [[.png}]]
            .. [[\caption{LASSO regression, \(\num{1000}\) training states.}]]
        .. [[\end{subfigure}]]
...
\begin{table}[H]
    ...
    \pgfplotstabletypeset[columns/lambda/.style={column name={$\lambda$},dec sep align},columns/Momentum/.style={fixed},sci, sci zerofill,precision=1]{data/logreg_table.dat}
\end{table}
